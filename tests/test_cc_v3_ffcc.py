...
def core():
    path = Path(__file__).resolve().parents[1] / "scripts/cc_v3_ffcc.py"
    assert path.exists(), "FFCC-inspired numerical core is not implemented"
    spec = importlib.util.spec_from_file_location("cc_v3_ffcc", path)
