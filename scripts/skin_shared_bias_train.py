...
def main():
    ...
    files += [ROOT/'scripts/skin_shared_bias.py',ROOT/'tests/test_skin_shared_bias.py',ROOT/'scripts/skin_mskcc_train_pixels.py',ROOT/'scripts/skin_mskcc_summary_pilot.py',ROOT/'scripts/skin_mskcc_data.py']
    files += [ROOT/'data/processed/skin_mskcc_pixels_v1'/name for name in ['train.npz','validation.npz']]
