...
def main():
    ...
    files=[PROTOCOL,Path(__file__),ROOT/'scripts/skin_copula_model.py',ROOT/'tests/test_skin_copula_model.py',
    ...
    files+=[ROOT/'scripts/skin_copula_data.py',ROOT/'tests/test_skin_copula.py',OUT/'feature_receipt.json']
    files+=[ROOT/'data/processed/skin_copula_v1'/f'{role}.npz' for role in ['train','validation']]
