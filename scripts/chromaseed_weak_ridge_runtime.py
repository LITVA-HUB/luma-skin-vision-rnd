...
def runtime(run, cache, output):
    ...
    result = {"source_lock_sha256": sha(run / "source_lock.json"), "selection_sha256": sha(run / "selections.json"),
              ...
              "fixed_step_scope": "six fixed seed17/width1/alpha0.0001/16-step audit-probe cases; additional timing only, not selected models or new outer quality measurements"}
