...
def main():
    parser=argparse.ArgumentParser();parser.add_argument('--arch',choices=['all','cnn','votes_mean','votes_huber3'],default='all')
    ...
    for seed in args.seeds:
        for arch in (['cnn','votes_mean','votes_huber3'] if args.arch=='all' else [args.arch]):
