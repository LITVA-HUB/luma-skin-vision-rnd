...
OUT=ROOT/'docs/benchmarks/skin_color_sampling_mass_v1';RUN=ROOT/'experiments/runs/skin_color_sampling_mass_v1'
PROTOCOL=ROOT/'docs/research/skin_color_sampling_mass_protocol_v1.md';SEEDS=(17,29,43)
...
def bindings():
    base=prior_bindings();paths=[ROOT/'scripts/skin_color_sampling.py',PROTOCOL,Path(__file__),ROOT/'scripts/skin_color_sampling_mass.py',ROOT/'tests/test_skin_color_sampling_mass.py']
...
def main():
    ...
    if args.stage=='prepare':
        ...
        else:write(lock,{'bindings':bound,'fits':6,'arms':ARMS,'seeds':SEEDS,'primary':'fixed_final_930_updates'})
