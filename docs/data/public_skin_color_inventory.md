...
|---|---|---|---|
|[MSKCC Skin Tone Labeling](https://api.isic-archive.com/doi/mskcc-skin-tone-labeling-dataset/)|Original4879images/64people; instrument-paired1838normal-skin images/474sites/46people after3missing-ID exclusions. SkinColorCatch triplicate native Lab; manufacturer D65/10deg.453clinical close-ups+1385dermoscopic; CanonT6i and iPodTouch7, study-calibrated capture.|CLEARED FOR R&D AND COMMERCIAL MODEL TRAINING under original CC-BY attribution grant; version unspecified on landing page. Every metadata record CC-BY. No author weights adopted. Fullbundle5,855,692,278B; acquiring only instrument-paired original images.|Direct DeltaE00 source-validation pilot completed; ten-person test unopened. Controlled close-ups, not everyday facial selfies. See skin_mskcc_summary_v1 benchmark and skin_mskcc_protocol_v1.|
