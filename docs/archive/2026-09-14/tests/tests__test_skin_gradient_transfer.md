# `tests/test_skin_gradient_transfer.py`

[Архив](../README.md) · [Индекс](../TESTS.md) · [Полный исходник](../../../../tests/test_skin_gradient_transfer.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Grouping, transfer signs and exact restoration on an analytic regression.

SHA-256 исходника: `a5bea802ff003dfc6f4a5c50c5b577c329dff2730182f579fbf2f9a05aa5efd6`. Строк: **51**.
...
|---|---|---|---|
| `test_partition_preserves_examples_sizes_and_pooled_objective` | FunctionDef | См. реализацию | [L9](../../../../tests/test_skin_gradient_transfer.py#L9) |
| `test_stationary_pooled_gradient_does_not_imply_harmful_learning` | FunctionDef | См. реализацию | [L22](../../../../tests/test_skin_gradient_transfer.py#L22) |
| `test_finite_step_matches_quadratic_and_restores_on_exception` | FunctionDef | См. реализацию | [L31](../../../../tests/test_skin_gradient_transfer.py#L31) |

## Все тестовые определения (3)

Параметризация показана дословно. Число определений не равно числу развёрнутых pytest cases; фикстуры и окружение влияют на сборку. Эти тесты не запускались при подготовке атласа.

### `test_partition_preserves_examples_sizes_and_pooled_objective` · L9
...
### `test_stationary_pooled_gradient_does_not_imply_harmful_learning` · L22
...
### `test_finite_step_matches_quadratic_and_restores_on_exception` · L31
