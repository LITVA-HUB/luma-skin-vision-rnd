# `tests/test_cc_v4_geometry.py`

[Архив](../README.md) · [Индекс](../TESTS.md) · [Полный исходник](../../../../tests/test_cc_v4_geometry.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Constructed mathematical target checks; no new real benchmark evidence.

SHA-256 исходника: `861c6f42b119a86d75bf29d505d51069afe1ba34ae310ad70398889dd87efc77`. Строк: **57**.
...
|---|---|---|---|
| `test_exact_correction_has_zero_cost_and_gradient` | FunctionDef | См. реализацию | [L13](../../../../tests/test_cc_v4_geometry.py#L13) |
| `test_analytic_action_derivative_matches_finite_difference` | FunctionDef | См. реализацию | [L22](../../../../tests/test_cc_v4_geometry.py#L22) |
| `test_joint_gain_action_translation_and_gt_scale_invariance` | FunctionDef | См. реализацию | [L40](../../../../tests/test_cc_v4_geometry.py#L40) |
| `test_invalid_targets_refuse` | FunctionDef | См. реализацию | [L53](../../../../tests/test_cc_v4_geometry.py#L53) |

## Все тестовые определения (4)

Параметризация показана дословно. Число определений не равно числу развёрнутых pytest cases; фикстуры и окружение влияют на сборку. Эти тесты не запускались при подготовке атласа.

### `test_exact_correction_has_zero_cost_and_gradient` · L13
...
### `test_analytic_action_derivative_matches_finite_difference` · L22
...
### `test_joint_gain_action_translation_and_gt_scale_invariance` · L40
...
### `test_invalid_targets_refuse` · L53
