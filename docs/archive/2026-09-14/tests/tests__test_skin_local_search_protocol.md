# `tests/test_skin_local_search_protocol.py`

[Архив](../README.md) · [Индекс](../TESTS.md) · [Полный исходник](../../../../tests/test_skin_local_search_protocol.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Independent split, weighting, and artifact checks for the TRAIN-only runner.

SHA-256 исходника: `9b963e1120635d1ff09e01f28cd312c20ada09d7006f00e3bdde0571e4b0fc03`. Строк: **138**.
...
[Строка 11](../../../../tests/test_skin_local_search_protocol.py#L11)
...
|---|---|---|---|
| `_original_train_cache` | FunctionDef | См. реализацию | [L15](../../../../tests/test_skin_local_search_protocol.py#L15) |
| `test_original_train_metadata_reproduces_outer_roles_and_person_folds` | FunctionDef | См. реализацию | [L22](../../../../tests/test_skin_local_search_protocol.py#L22) |
| `test_acquisition_weights_equalize_people_then_sites_then_images` | FunctionDef | См. реализацию | [L57](../../../../tests/test_skin_local_search_protocol.py#L57) |
| `test_fit_selection_is_invariant_to_outer_target_sentinel` | FunctionDef | См. реализацию | [L75](../../../../tests/test_skin_local_search_protocol.py#L75) |
| `test_canonical_float32_payload_roundtrips_exactly` | FunctionDef | См. реализацию | [L120](../../../../tests/test_skin_local_search_protocol.py#L120) |

## Все тестовые определения (4)

Параметризация показана дословно. Число определений не равно числу развёрнутых pytest cases; фикстуры и окружение влияют на сборку. Эти тесты не запускались при подготовке атласа.

### `test_original_train_metadata_reproduces_outer_roles_and_person_folds` · L22
...
### `test_acquisition_weights_equalize_people_then_sites_then_images` · L57
...
### `test_fit_selection_is_invariant_to_outer_target_sentinel` · L75
...
### `test_canonical_float32_payload_roundtrips_exactly` · L120
