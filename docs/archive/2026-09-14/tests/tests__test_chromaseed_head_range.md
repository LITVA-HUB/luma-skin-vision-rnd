# `tests/test_chromaseed_head_range.py`

[Архив](../README.md) · [Индекс](../TESTS.md) · [Полный исходник](../../../../tests/test_chromaseed_head_range.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

CPU-only behavior of output-range changes, separate from running AS training.

SHA-256 исходника: `c8a3bf6407b25e9c6fb27b33f0233d0bf278b41ac9a3e618ce7ab245f0e52602`. Строк: **94**.
...
|---|---|---|---|
| `test_head_range_and_identical_value_and_slope_at_zero` | FunctionDef | См. реализацию | [L18](../../../../tests/test_chromaseed_head_range.py#L18) |
| `test_unit_mode_preserves_original_forward_backward_and_export_exactly` | FunctionDef | См. реализацию | [L36](../../../../tests/test_chromaseed_head_range.py#L36) |
| `test_every_architecture_can_reach_a_reference_outside_original_range` | FunctionDef | См. реализацию | [L58](../../../../tests/test_chromaseed_head_range.py#L58) |
| `test_changed_head_has_independent_numpy_and_torch_agreement` | FunctionDef | См. реализацию | [L84](../../../../tests/test_chromaseed_head_range.py#L84) |

## Все тестовые определения (4)

Параметризация показана дословно. Число определений не равно числу развёрнутых pytest cases; фикстуры и окружение влияют на сборку. Эти тесты не запускались при подготовке атласа.

### `test_head_range_and_identical_value_and_slope_at_zero` · L18
...
### `test_unit_mode_preserves_original_forward_backward_and_export_exactly` · L36
...
### `test_every_architecture_can_reach_a_reference_outside_original_range` · L58
...
### `test_changed_head_has_independent_numpy_and_torch_agreement` · L84
