# `tests/test_skin_appearance_inverse.py`

[Архив](../README.md) · [Индекс](../TESTS.md) · [Полный исходник](../../../../tests/test_skin_appearance_inverse.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Модуль исследовательского архива; назначение уточняется по определениям и связанному протоколу.

SHA-256 исходника: `3f38e2fee9279eaa7e36e98f5ede7046ae3ca6b1d791215f42357b8000310d74`. Строк: **45**.
...
|---|---|---|---|
| `test_polynomial_design_and_affine_recovery` | FunctionDef | См. реализацию | [L8](../../../../tests/test_skin_appearance_inverse.py#L8) |
| `test_marginal_likelihood_keeps_gaussian_normalizer_and_uniform_atom_prior` | FunctionDef | См. реализацию | [L16](../../../../tests/test_skin_appearance_inverse.py#L16) |
| `test_uniform_likelihood_recovers_prior_and_extreme_inputs_remain_finite` | FunctionDef | См. реализацию | [L30](../../../../tests/test_skin_appearance_inverse.py#L30) |
| `test_color_decision_minimizes_actual_expected_palette_error` | FunctionDef | См. реализацию | [L37](../../../../tests/test_skin_appearance_inverse.py#L37) |

## Все тестовые определения (4)

Параметризация показана дословно. Число определений не равно числу развёрнутых pytest cases; фикстуры и окружение влияют на сборку. Эти тесты не запускались при подготовке атласа.

### `test_polynomial_design_and_affine_recovery` · L8
...
### `test_marginal_likelihood_keeps_gaussian_normalizer_and_uniform_atom_prior` · L16
...
### `test_uniform_likelihood_recovers_prior_and_extreme_inputs_remain_finite` · L30
...
### `test_color_decision_minimizes_actual_expected_palette_error` · L37
