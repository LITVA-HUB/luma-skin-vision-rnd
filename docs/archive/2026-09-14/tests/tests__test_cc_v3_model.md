# `tests/test_cc_v3_model.py`

[Архив](../README.md) · [Индекс](../TESTS.md) · [Полный исходник](../../../../tests/test_cc_v3_model.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

SYNTHETIC CPU numerical probes, never benchmark accuracy evidence.

SHA-256 исходника: `b1395418e80a0d7a0af7dead784ba4b0324c2afca7aa5fcc9206a449492e7a46`. Строк: **263**.
...
|---|---|---|---|
| `core` | FunctionDef | См. реализацию | [L12](../../../../tests/test_cc_v3_model.py#L12) |
| `cpu_threads` | FunctionDef | См. реализацию | [L22](../../../../tests/test_cc_v3_model.py#L22) |
| `scene` | FunctionDef | См. реализацию | [L29](../../../../tests/test_cc_v3_model.py#L29) |
| `test_frame_selection_is_max_volume_and_lexicographic_on_ties` | FunctionDef | См. реализацию | [L38](../../../../tests/test_cc_v3_model.py#L38) |
| `test_nontrivial_learned_point_and_posterior_are_projectively_equivariant` | FunctionDef | См. реализацию | [L55](../../../../tests/test_cc_v3_model.py#L55) |
| `test_forward_loss_and_actual_backward_are_finite` | FunctionDef | См. реализацию | [L73](../../../../tests/test_cc_v3_model.py#L73) |
| `test_modes_have_identical_trainable_parameter_shapes_and_count` | FunctionDef | См. реализацию | [L93](../../../../tests/test_cc_v3_model.py#L93) |
| `test_invalid_input_and_rank_deficiency_refuse_with_finite_positive_diagnostics` | FunctionDef | См. реализацию | [L99](../../../../tests/test_cc_v3_model.py#L99) |
| `test_nonpositive_raw_point_is_refused_without_clipping` | FunctionDef | См. реализацию | [L120](../../../../tests/test_cc_v3_model.py#L120) |
| `test_vmf_log_normalizer_and_sphere_density_integral` | FunctionDef | См. реализацию | [L133](../../../../tests/test_cc_v3_model.py#L133) |
| `test_vmf_large_float32_concentration_has_finite_gradient` | FunctionDef | См. реализацию | [L148](../../../../tests/test_cc_v3_model.py#L148) |
| `test_canonical_target_solves_frame_and_nll_matches_single_component_density` | FunctionDef | См. реализацию | [L157](../../../../tests/test_cc_v3_model.py#L157) |
| `test_camera_density_applies_spherical_jacobian_and_is_scale_independent` | FunctionDef | См. реализацию | [L168](../../../../tests/test_cc_v3_model.py#L168) |
| `test_target_and_both_likelihoods_ignore_extreme_positive_scalar_magnitudes` | FunctionDef | См. реализацию | [L181](../../../../tests/test_cc_v3_model.py#L181) |
| `test_complete_vmf_density_retains_large_concentration_peak_and_tiny_angle_penalty` | FunctionDef | См. реализацию | [L198](../../../../tests/test_cc_v3_model.py#L198) |
| `test_near_tie_frame_switch_exposes_discontinuous_canonical_coordinates` | FunctionDef | См. реализацию | [L215](../../../../tests/test_cc_v3_model.py#L215) |
| `test_random_positive_well_conditioned_mixing_preserves_canonical_features` | FunctionDef | См. реализацию | [L231](../../../../tests/test_cc_v3_model.py#L231) |
| `test_risk_transport_depends_on_concentration_and_is_not_gl_invariant` | FunctionDef | См. реализацию | [L244](../../../../tests/test_cc_v3_model.py#L244) |

## Все тестовые определения (15)

Параметризация показана дословно. Число определений не равно числу развёрнутых pytest cases; фикстуры и окружение влияют на сборку. Эти тесты не запускались при подготовке атласа.

### `test_frame_selection_is_max_volume_and_lexicographic_on_ties` · L38
...
### `test_nontrivial_learned_point_and_posterior_are_projectively_equivariant` · L55
...
```python
@pytest.mark.parametrize('transform', [[[1.2, 0.12, 0.04], [0.04, 0.9, 0.09], [0.1, 0.06, 1.1]], [[1.3, 0.0, 0.0], [0.0, 0.7, 0.0], [0.0, 0.0, 1.1]]])
...
### `test_forward_loss_and_actual_backward_are_finite` · L73
...
### `test_modes_have_identical_trainable_parameter_shapes_and_count` · L93
...
### `test_invalid_input_and_rank_deficiency_refuse_with_finite_positive_diagnostics` · L99
...
### `test_nonpositive_raw_point_is_refused_without_clipping` · L120
...
### `test_vmf_log_normalizer_and_sphere_density_integral` · L133
...
### `test_vmf_large_float32_concentration_has_finite_gradient` · L148
...
### `test_canonical_target_solves_frame_and_nll_matches_single_component_density` · L157
...
### `test_camera_density_applies_spherical_jacobian_and_is_scale_independent` · L168
...
### `test_target_and_both_likelihoods_ignore_extreme_positive_scalar_magnitudes` · L181
...
### `test_complete_vmf_density_retains_large_concentration_peak_and_tiny_angle_penalty` · L198
...
### `test_near_tie_frame_switch_exposes_discontinuous_canonical_coordinates` · L215
...
### `test_random_positive_well_conditioned_mixing_preserves_canonical_features` · L231
...
### `test_risk_transport_depends_on_concentration_and_is_not_gl_invariant` · L244
