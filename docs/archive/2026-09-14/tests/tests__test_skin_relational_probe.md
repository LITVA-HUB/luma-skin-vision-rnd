# `tests/test_skin_relational_probe.py`

[Архив](../README.md) · [Индекс](../TESTS.md) · [Полный исходник](../../../../tests/test_skin_relational_probe.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Relational degeneracy, matched controls and excluded-person regression.

SHA-256 исходника: `aaf4c17b63da27034e64365213456fe4fa1e836ffdd91e8b5acb2c76af2ed7d2`. Строк: **50**.
...
|---|---|---|---|
| `test_additive_reference_bank_and_cycle_projection_are_not_new_information` | FunctionDef | См. реализацию | [L8](../../../../tests/test_skin_relational_probe.py#L8) |
| `test_controls_preserve_person_capture_and_exclude_reference_site` | FunctionDef | См. реализацию | [L24](../../../../tests/test_skin_relational_probe.py#L24) |
| `test_excluded_person_regression_cannot_use_held_targets` | FunctionDef | См. реализацию | [L40](../../../../tests/test_skin_relational_probe.py#L40) |

## Все тестовые определения (3)

Параметризация показана дословно. Число определений не равно числу развёрнутых pytest cases; фикстуры и окружение влияют на сборку. Эти тесты не запускались при подготовке атласа.

### `test_additive_reference_bank_and_cycle_projection_are_not_new_information` · L8
...
### `test_controls_preserve_person_capture_and_exclude_reference_site` · L24
...
### `test_excluded_person_regression_cannot_use_held_targets` · L40
