...
[Архив](../README.md) · [Индекс](../TESTS.md) · [Полный исходник](../../../../tests/test_chromaseed_fused_optimizer.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

CPU-only numerical behavior; this suite never initializes a CUDA context.

SHA-256 исходника: `fd7d4297ffaef30d584de6ab70b516d065b403b04e8f1fcd6c6839845cf4f8fb`. Строк: **92**.
...
|---|---|---|---|
| `test_slot_rates_clip_decay_and_moments_against_float64_equations` | FunctionDef | См. реализацию | [L14](../../../../tests/test_chromaseed_fused_optimizer.py#L14) |
| `test_reset_replays_exactly_without_replacing_parameter_storage` | FunctionDef | См. реализацию | [L45](../../../../tests/test_chromaseed_fused_optimizer.py#L45) |
| `test_matches_existing_optimizer_numerically_for_identical_gradient_stream` | FunctionDef | См. реализацию | [L70](../../../../tests/test_chromaseed_fused_optimizer.py#L70) |
| `test_actual_four_pass_network_with_coupled_gradients` | FunctionDef | См. реализацию | [L87](../../../../tests/test_chromaseed_fused_optimizer.py#L87) |

## Все тестовые определения (4)

Параметризация показана дословно. Число определений не равно числу развёрнутых pytest cases; фикстуры и окружение влияют на сборку. Эти тесты не запускались при подготовке атласа.

### `test_slot_rates_clip_decay_and_moments_against_float64_equations` · L14
...
### `test_reset_replays_exactly_without_replacing_parameter_storage` · L45
...
### `test_matches_existing_optimizer_numerically_for_identical_gradient_stream` · L70
...
### `test_actual_four_pass_network_with_coupled_gradients` · L87
