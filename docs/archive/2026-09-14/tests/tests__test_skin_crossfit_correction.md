# `tests/test_skin_crossfit_correction.py`

[Архив](../README.md) · [Индекс](../TESTS.md) · [Полный исходник](../../../../tests/test_skin_crossfit_correction.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Subject roles, matched inclusion controls and stable color-coordinate heads.

SHA-256 исходника: `6419bd6c5d69e13bc8c71427ab7df752ecd863ffb0cf925ecc8f31fddc40e0ce`. Строк: **49**.
...
|---|---|---|---|
| `test_inner_folds_exclude_whole_people_and_match_camera_support` | FunctionDef | См. реализацию | [L10](../../../../tests/test_skin_crossfit_correction.py#L10) |
| `test_crossfit_and_same_size_in_sample_use_distinct_correct_encoders` | FunctionDef | См. реализацию | [L26](../../../../tests/test_skin_crossfit_correction.py#L26) |
| `test_stable_head_coordinates_capacity_and_zero_initial_correction` | FunctionDef | См. реализацию | [L38](../../../../tests/test_skin_crossfit_correction.py#L38) |

## Все тестовые определения (3)

Параметризация показана дословно. Число определений не равно числу развёрнутых pytest cases; фикстуры и окружение влияют на сборку. Эти тесты не запускались при подготовке атласа.

### `test_inner_folds_exclude_whole_people_and_match_camera_support` · L10
...
### `test_crossfit_and_same_size_in_sample_use_distinct_correct_encoders` · L26
...
### `test_stable_head_coordinates_capacity_and_zero_initial_correction` · L38
