# `tests/test_chromaseed_refine.py`

[Архив](../README.md) · [Индекс](../TESTS.md) · [Полный исходник](../../../../tests/test_chromaseed_refine.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Модуль исследовательского архива; назначение уточняется по определениям и связанному протоколу.

SHA-256 исходника: `585bd1842d8ffd77cd2d9d990739466c244cacc270fb47dde9550759649ed9a3`. Строк: **125**.
...
|---|---|---|---|
| `test_bank_adamw_matches_independent_torch_optimizers_with_clipping` | FunctionDef | См. реализацию | [L11](../../../../tests/test_chromaseed_refine.py#L11) |
| `test_bank_network_is_independent_and_exportable` | FunctionDef | См. реализацию | [L38](../../../../tests/test_chromaseed_refine.py#L38) |
| `test_dynamic_gate_changes_connection_count_and_retains_learning_signal` | FunctionDef | См. реализацию | [L74](../../../../tests/test_chromaseed_refine.py#L74) |
| `test_adaptive_exit_really_stops_and_matches_full_trace_policy` | FunctionDef | См. реализацию | [L89](../../../../tests/test_chromaseed_refine.py#L89) |
| `test_fold_preprocessor_does_not_depend_on_held_rows_and_anchor_learns` | FunctionDef | См. реализацию | [L106](../../../../tests/test_chromaseed_refine.py#L106) |

## Все тестовые определения (5)

Параметризация показана дословно. Число определений не равно числу развёрнутых pytest cases; фикстуры и окружение влияют на сборку. Эти тесты не запускались при подготовке атласа.

### `test_bank_adamw_matches_independent_torch_optimizers_with_clipping` · L11
...
### `test_bank_network_is_independent_and_exportable` · L38
...
### `test_dynamic_gate_changes_connection_count_and_retains_learning_signal` · L74
...
### `test_adaptive_exit_really_stops_and_matches_full_trace_policy` · L89
...
### `test_fold_preprocessor_does_not_depend_on_held_rows_and_anchor_learns` · L106
