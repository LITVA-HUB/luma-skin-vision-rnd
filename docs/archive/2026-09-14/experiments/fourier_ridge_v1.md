...
[Полная папка артефактов](../../../../docs/benchmarks/fourier_ridge_v1)
...
|---|---|---|
| [verification.json](../../../../docs/benchmarks/fourier_ridge_v1/verification.json) | {"status": "ALL HASHES AND REPLAYS PASSED"} | `6910a6b5890b55e532706f5b17244924c3002e87aa23b65d0fe225ebc2ebe928` |
