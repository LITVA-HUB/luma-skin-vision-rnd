# `scripts/skin_color_sampling_mass_train.py`

[Архив](../README.md) · [Индекс](../SOURCE_INDEX.md) · [Полный исходник](../../../../scripts/skin_color_sampling_mass_train.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Person-mass falsifier; exact original fixed-budget recipe.

SHA-256 исходника: `f28768221e039ea475c0bfa8664fcd552a39fdfddfa25a83d87df07cc92a43bd`. Строк: **95**.
...
import numpy as np
import torch
from skin_color_sampling_mass import ARMS,sampling_distribution,draw_indices
...
[Строка 20](../../../../scripts/skin_color_sampling_mass_train.py#L20)

```python
OUT=ROOT/'docs/benchmarks/skin_color_sampling_mass_v1'
```

[Строка 20](../../../../scripts/skin_color_sampling_mass_train.py#L20)

```python
RUN=ROOT/'experiments/runs/skin_color_sampling_mass_v1'
```

[Строка 21](../../../../scripts/skin_color_sampling_mass_train.py#L21)

```python
PROTOCOL=ROOT/'docs/research/skin_color_sampling_mass_protocol_v1.md'
```
...
|---|---|---|---|
| `fit` | FunctionDef | См. реализацию | [L24](../../../../scripts/skin_color_sampling_mass_train.py#L24) |
| `bindings` | FunctionDef | См. реализацию | [L77](../../../../scripts/skin_color_sampling_mass_train.py#L77) |
| `main` | FunctionDef | См. реализацию | [L82](../../../../scripts/skin_color_sampling_mass_train.py#L82) |
...
def fit(data,arm,seed):
    ...
    q,correction,info=sampling_distribution(tr,arm,seed)
    ...
    r={'arm':arm,'seed':seed,'train_people':18,'holdout_people':6,'train_images':len(x),'holdout_images':len(vx),'train_sites':info['site_count'],
        ...
        'old_control_exact_state':exact_old,'protocol_sha256':sha(PROTOCOL),'training_code_sha256':sha(Path(__file__)),'sampling_code_sha256':sha(ROOT/'scripts/skin_color_sampling_mass.py'),
