# `scripts/skin_train_branch_train.py`

[Архив](../README.md) · [Индекс](../SOURCE_INDEX.md) · [Полный исходник](../../../../scripts/skin_train_branch_train.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Predeclared fitting-only branch follow-up on exposed source roles.

SHA-256 исходника: `7487b905774bed608fa61824e9318d5223ea80bc94a76556269134136733e29b`. Строк: **123**.
...
[Строка 17](../../../../scripts/skin_train_branch_train.py#L17)

```python
OUT=ROOT/'docs/benchmarks/skin_train_branch_v1'
```

[Строка 18](../../../../scripts/skin_train_branch_train.py#L18)

```python
RUN=ROOT/'experiments/runs/skin_train_branch_v1'
```

[Строка 19](../../../../scripts/skin_train_branch_train.py#L19)

```python
PROTOCOL=ROOT/'docs/research/skin_train_branch_protocol_v1.md'
```

[Строка 20](../../../../scripts/skin_train_branch_train.py#L20)
...
|---|---|---|---|
| `prediction` | FunctionDef | См. реализацию | [L23](../../../../scripts/skin_train_branch_train.py#L23) |
| `selective` | FunctionDef | См. реализацию | [L33](../../../../scripts/skin_train_branch_train.py#L33) |
| `fit` | FunctionDef | См. реализацию | [L42](../../../../scripts/skin_train_branch_train.py#L42) |
| `main` | FunctionDef | См. реализацию | [L101](../../../../scripts/skin_train_branch_train.py#L101) |
