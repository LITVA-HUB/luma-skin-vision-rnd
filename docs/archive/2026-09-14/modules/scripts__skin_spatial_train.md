# `scripts/skin_spatial_train.py`

[Архив](../README.md) · [Индекс](../SOURCE_INDEX.md) · [Полный исходник](../../../../scripts/skin_spatial_train.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Frozen real-photo source screen; no reserved endpoints or spectral pseudo-labels.

SHA-256 исходника: `8d8198a19571afa10457acfc74a8eeedc3042be9ac7fca20509909d23f4e35fc`. Строк: **123**.
...
[Строка 17](../../../../scripts/skin_spatial_train.py#L17)

```python
OUT=ROOT/'docs/benchmarks/skin_spatial_v1'
```

[Строка 18](../../../../scripts/skin_spatial_train.py#L18)

```python
RUN=ROOT/'experiments/runs/skin_spatial_v1'
```

[Строка 19](../../../../scripts/skin_spatial_train.py#L19)

```python
PROTOCOL=ROOT/'docs/research/skin_spatial_protocol_v1.md'
```

[Строка 20](../../../../scripts/skin_spatial_train.py#L20)
...
|---|---|---|---|
| `prediction` | FunctionDef | См. реализацию | [L23](../../../../scripts/skin_spatial_train.py#L23) |
| `selective` | FunctionDef | См. реализацию | [L33](../../../../scripts/skin_spatial_train.py#L33) |
| `fit` | FunctionDef | См. реализацию | [L42](../../../../scripts/skin_spatial_train.py#L42) |
| `main` | FunctionDef | См. реализацию | [L101](../../../../scripts/skin_spatial_train.py#L101) |
