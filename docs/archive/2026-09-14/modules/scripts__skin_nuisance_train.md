# `scripts/skin_nuisance_train.py`

[Архив](../README.md) · [Индекс](../SOURCE_INDEX.md) · [Полный исходник](../../../../scripts/skin_nuisance_train.py)

> Статическая документация исходника. Наличие теста или функции не означает, что её запуск завершён успешно.

Fixed causal controls for training-only latent nuisance perturbation.

SHA-256 исходника: `fa02bc7fd4d3156454de9316511c6ae9191e8e80240cdd9522978b15d1b38698`. Строк: **123**.
...
[Строка 17](../../../../scripts/skin_nuisance_train.py#L17)

```python
OUT=ROOT/'docs/benchmarks/skin_nuisance_v1'
```

[Строка 18](../../../../scripts/skin_nuisance_train.py#L18)

```python
RUN=ROOT/'experiments/runs/skin_nuisance_v1'
```

[Строка 19](../../../../scripts/skin_nuisance_train.py#L19)

```python
PROTOCOL=ROOT/'docs/research/skin_nuisance_protocol_v1.md'
```

[Строка 20](../../../../scripts/skin_nuisance_train.py#L20)
...
|---|---|---|---|
| `prediction` | FunctionDef | См. реализацию | [L23](../../../../scripts/skin_nuisance_train.py#L23) |
| `selective` | FunctionDef | См. реализацию | [L33](../../../../scripts/skin_nuisance_train.py#L33) |
| `fit` | FunctionDef | См. реализацию | [L42](../../../../scripts/skin_nuisance_train.py#L42) |
| `main` | FunctionDef | См. реализацию | [L101](../../../../scripts/skin_nuisance_train.py#L101) |
