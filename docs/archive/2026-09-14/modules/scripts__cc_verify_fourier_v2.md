# `scripts/cc_verify_fourier_v2.py`

[Архив](../README.md) · [Индекс](../SOURCE_INDEX.md) · [Полный исходник](../../../../scripts/cc_verify_fourier_v2.py)
...
[Строка 19](../../../../scripts/cc_verify_fourier_v2.py#L19)
...
|---|---|---|---|
| `independently_error` | FunctionDef | См. реализацию | [L22](../../../../scripts/cc_verify_fourier_v2.py#L22) |
| `verify_manifest` | FunctionDef | См. реализацию | [L28](../../../../scripts/cc_verify_fourier_v2.py#L28) |
| `run` | FunctionDef | См. реализацию | [L35](../../../../scripts/cc_verify_fourier_v2.py#L35) |
