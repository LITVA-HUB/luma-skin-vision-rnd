# `scripts/cc_v6_oracle_audit.py`

[Архив](../README.md) · [Индекс](../SOURCE_INDEX.md) · [Полный исходник](../../../../scripts/cc_v6_oracle_audit.py)
...
|---|---|---|---|
| `corrected_oracle` | FunctionDef | См. реализацию | [L18](../../../../scripts/cc_v6_oracle_audit.py#L18) |
| `run` | FunctionDef | См. реализацию | [L33](../../../../scripts/cc_v6_oracle_audit.py#L33) |
