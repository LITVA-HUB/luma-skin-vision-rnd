...
def run(args):
    ...
    dependencies = ['cc_v5_experiment.py', 'cc_v5_model.py', 'cc_v4_experiment.py', 'cc_v4_model.py',
    ...
    shutil.copyfile(ROOT / 'docs/research/cc_v5_protocol.md', out / 'protocol.md')
    ...
    model = CorrectionEvidenceNet(mode='posterior').to(device)
